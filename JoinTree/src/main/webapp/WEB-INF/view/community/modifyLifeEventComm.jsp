...
<html>
	...
	<jsp:include page="/WEB-INF/view/inc/header.jsp"/> 
        ...
        .ck-editor__editable {
   		...
   		<!-- <script src="/JoinTree/resource/js/community/modifyLifeEventComm.js"></script>	 -->
   		<script>
			...
			<jsp:include page="/WEB-INF/view/inc/sideContent.jsp"/> <!-- 사이드바 -->
				...
				<div class="col-lg-12 grid-margin stretch-card">
					<div class="card">
						...
						<!-- 게시글 수정 폼 -->
						<form action="/JoinTree/community/modifyComm" method="post" id="modifyLifeEventComm">
							...
							<div class="row">
								...
								<div class="col d-flex justify-content-end align-items-center">
									...
									<button type="button" id="modifyLifeEventCommBtn" class="btn btn-success btn-fw">게시글 수정</button>
								</div>
							</div>
							<hr>
							<div>
