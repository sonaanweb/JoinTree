...
<html>
	...
	<script src="/JoinTree/resource/js/community/lifeEventCommList.js"></script>
	...
	<jsp:include page="/WEB-INF/view/inc/sideContent.jsp"/> <!-- 사이드바 -->
		...
		<div class="col-lg-12 grid-margin stretch-card">
        	<div class="card">
              	<div class="card-body">
					<h3 class="font-weight-bold">경조사 게시판</h3>
					<hr>
					<div class="text-right">
						<a href="/JoinTree/community/lifeEventCommList/addLifeEventComm" class="btn btn-success btn-sm">게시글 작성</a>
					</div><br>
