		...
		<div class="container-fluid page-body-wrapper">
			<jsp:include page="/WEB-INF/view/inc/sideContent.jsp"/> <!-- 사이드바 -->
				<div class="content-wrapper"> <!-- 컨텐츠부분 wrapper -->
					...
					<a href="/JoinTree/community/anonymousCommList/anonymousCommOne?boardNo=${comm.boardNo}" class="btn btn-success btn-sm">이전</a><br>
				</div><br>				
						...
						<form action="/JoinTree/community/modifyComm" method="post" id="modifyAnonymousComm">
							...
							<div class="row">
								...
								<div class="col d-flex justify-content-end align-items-center">
									...
									<button type="button" id="modifyAnonymousCommBtn" class="btn btn-success btn-fw">게시글 수정</button>
								</div>
							</div>
							<hr>
							<div>
