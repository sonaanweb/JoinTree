...
<html>
	...
	<jsp:include page="/WEB-INF/view/inc/header.jsp"/> 
	    ...
	    <style>
   		...
   		<!-- <script src="/JoinTree/resource/js/community/modifyFreeComm.js"></script> -->
		<script>
		...
		<div class="container-fluid page-body-wrapper">
			...
			<div class="content-wrapper"> <!-- 컨텐츠부분 wrapper -->
				<div class="col-lg-12 text-right">	
					<a href="/JoinTree/community/freeCommList/freeCommOne?boardNo=${comm.boardNo}" class="btn btn-success btn-sm">이전</a><br>
				</div><br>				
						...
						<form action="/JoinTree/community/modifyComm" method="post" id="modifyFreeComm">
							...
							<div class="row">
								...
								<div class="col d-flex justify-content-end align-items-center">
									...
									<button type="button" id="modifyFreeCommBtn" class="btn btn-success btn-fw">게시글 수정</button>
								</div>
							</div>
							<hr>
							<div>
