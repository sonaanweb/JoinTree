		...
		<jsp:include page="/WEB-INF/view/inc/sideContent.jsp"/> <!-- 사이드바 -->
			...
			<div class="col-lg-12 text-right">
				<c:if test="${preBoard.boardNo ne null}">
					<a href="freeCommOne?boardNo=${preBoard.boardNo}" class="btn btn-success btn-sm">이전글</a>
				</c:if>
				<c:if test="${nextBoard.boardNo ne null}">
					<a href="freeCommOne?boardNo=${nextBoard.boardNo}" class="btn btn-success btn-sm">다음글</a>
				</c:if>
				<a href="/JoinTree/community/freeCommList" class="btn btn-success btn-sm">목록</a>
			</div>
			<br>
