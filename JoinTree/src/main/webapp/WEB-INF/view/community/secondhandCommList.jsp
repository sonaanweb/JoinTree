...
<html>
	...
	<script src="/JoinTree/resource/js/community/secondhandCommList.js"></script>
	<style>
		.selected-page {
		    font-weight: bold;
		...
		<div class="col-lg-12 grid-margin stretch-card">
        	<div class="card">
              	<div class="card-body">
					<h3 class="font-weight-bold">중고장터 게시판</h3>
					<hr>
					<div class="text-right">
						<a href="/JoinTree/community/secondhandCommList/addSecondhandComm" class="btn btn-success btn-sm">게시글 작성</a>
					</div><br>
