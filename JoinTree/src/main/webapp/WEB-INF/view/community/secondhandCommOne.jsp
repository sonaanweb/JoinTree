...
<html>
	...
	<script src="/JoinTree/resource/js/community/secondhandCommOne.js"></script>
		...
		<jsp:include page="/WEB-INF/view/inc/sideContent.jsp"/> <!-- 사이드바 -->
			...
			<div class="col-lg-12 text-right">
				<c:if test="${preBoard.boardNo ne null}">
					<a href="secondhandCommOne?boardNo=${preBoard.boardNo}" class="btn btn-success btn-sm">이전글</a>
				</c:if>
				<c:if test="${nextBoard.boardNo ne null}">
					<a href="secondhandCommOne?boardNo=${nextBoard.boardNo}" class="btn btn-success btn-sm">다음글</a>
				</c:if>
				<a href="/JoinTree/community/secondhandCommList" class="btn btn-success btn-sm">목록</a>
			</div>
			<br>
			...
			<div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body" >
                	<div>
						<h3>&#91;중고장터 게시판&#93;&nbsp;&nbsp;${comm.boardTitle}</h3>
						</div>
						<div>
