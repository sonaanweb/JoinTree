		...
		<script>
			...
			$(document).ready(function(){
				...
				function openUploadImgPopup() {
				    ...
				    // 팝업 내용 작성
				    let uploadPopupContent = "<h2>사진 등록</h2>" +
                    ...
                    // 등록 버튼에 클릭 이벤트 핸들러 등록
   				    $('#uploadImageBtn').click(function() {
   				    	console.log("팝업창 내 등록 버튼이 클릭되었습니다."); 
   				    	uploadImage();
   				    });
				...
				function uploadImage() {
				    ...
				    let fileInput = $('#uploadImg')[0]; // [0]은 jQuery 객체를 일반 JavaScript 엘리먼트로 변환
					...
					<td>
						...
						<c:choose>
							<c:when test="${empty empInfo.empSaveImgName or empInfo.empSaveImgName == '이미지 없음'}">
								...
								<input type="file"> &nbsp;
								<button type="button" id="uploadImgBtn">저장</button>
							</c:when>
							<c:otherwise>
